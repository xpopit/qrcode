...
import './App.css'
// const OpencvQr = window.OpencvQ
// mport OpencvQr from "opencv-qr";
  ...
  return (
    <div className="App">
      <input 
        ...
        accept="image/*"
      />
      <canvas ref={canvasRef} id="canvasInput"></canvas>
      
      <div>
        <button onClick={handleDetectClick}>ตรวจจับ QR Code</button>
